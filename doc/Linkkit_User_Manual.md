...
> 物联网平台是阿里云专门为物联网领域的开发人员推出的一款设备管理平台
>
...
![image](https://code.aliyun.com/edward.yangx/public-docs/raw/master/images/iotkit_scenario.png)

**在物联网套件场景架构图中, 物联网设备端C-SDK就是将嵌入式设备连接到阿里云的部分, 也是本手册将要详细介绍的**
