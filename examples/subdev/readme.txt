...
目前在网关上添加子设备支持两种方式：
    ...
    动态注册：在云端控制台手动添加设备，当网关上没有子设备的deviceSecret的时候，在网关通过接口接口IOT_Thing_Register/IOT_Subdevice_Register进行动态注册(IOTX_Thing_REGISTER_TYPE_DYNAMIC)可以获取子设备的deviceSecret.
