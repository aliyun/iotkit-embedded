...
const char *g_cli_crt = \
{
    \
    "-----BEGIN CERTIFICATE-----\r\n"
    "MIIDhzCCAm+gAwIBAgIHJSwUBlqodzANBgkqhkiG9w0BAQsFADBTMSgwJgYDVQQD\r\n"
    "DB9BbGliYWJhIENsb3VkIElvVCBPcGVyYXRpb24gQ0ExMRowGAYDVQQKDBFBbGli\r\n"
    "YWJhIENsb3VkIElvVDELMAkGA1UEBhMCQ04wIBcNMTkwOTI5MDkyMjQwWhgPMjEx\r\n"
    "OTA5MjkwOTIyNDBaMFExJjAkBgNVBAMTHUFsaWJhYmEgQ2xvdWQgSW9UIENlcnRp\r\n"
    "ZmljYXRlMRowGAYDVQQKExFBbGliYWJhIENsb3VkIElvVDELMAkGA1UEBhMCQ04w\r\n"
    "ggEiMA0GCSqGSIb3DQEBAQUAA4IBDwAwggEKAoIBAQDFyr5ay5a61yUfXYydOZWa\r\n"
    "F2y/NFWBKR43hAaV6UpXHErD06b0CdjQl6AXErIBLtFq0AoNVM5W9ejQ5nQq+WrW\r\n"
    "H9l6JbD46H/FpGE09ugX5OKXJ14+434xzEkBPtMhb3H35DXrZe4b7KS6jFx5/01J\r\n"
    "Q8GUiCAykATWElzqoiBDQjGR+HkAKfLpuhc4nsaBgGFW9HUwNrK8SQq5k/r/zcIa\r\n"
    "Sau8TZje4Wh0owzJaO/9ORB42pVvgPv4TcoCNFdxEwWQMfDLPAmccgMaFepKdonl\r\n"
    "SJPJzjhuNHjTFDSaXrMZhdy738bkXhEkOZKGuGV8b4+xqovOvtr1ozgK+k3Bdf6/\r\n"
    "AgMBAAGjYDBeMB8GA1UdIwQYMBaAFIJQSR2R3qxoXd1DB0Cgv3iGa8yKMB0GA1Ud\r\n"
    "DgQWBBTGh+vl6EHzM4VDoBjLvzyHKOi76TAOBgNVHQ8BAf8EBAMCA/gwDAYDVR0T\r\n"
    "AQH/BAIwADANBgkqhkiG9w0BAQsFAAOCAQEAQe9Wumt19jx8lYTskaTKjZ0JryV7\r\n"
    "9ZVyo6oB3jGVf/Co5Pw0c8QahsWMfSdQJ0xeQ+OxHqlh6Af4vkA9oBORskvNnoSM\r\n"
    "3Fbud1r1T/hvfn2MGJh+MPdoPMhXpSXq5+H87/i8pWge6YKUv3YxwrWo6gluqWmK\r\n"
    "U5murMrYGxZuq3l7OP+a1DOE/ZQx1i0auRhxJxEspEV214ul/xeuiNnnla8y8Gs9\r\n"
    "q/md5j4QGFlDiWDSmqSJWyk5lQtskH8igi/a3n5lW2UbPKEyEH2G+3ik9cu/dtJh\r\n"
    "akHci2N77g5F271r6Z+Az8aq+6YLz0vgvCZMmw5hvJeJkjOYJSDGQTtrvg==\r\n"
    "-----END CERTIFICATE-----\r\n"
};
...
const char *g_cli_key = \
{
    ...
    "MIIEpAIBAAKCAQEAxcq+WsuWutclH12MnTmVmhdsvzRVgSkeN4QGlelKVxxKw9Om\r\n"
    "9AnY0JegFxKyAS7RatAKDVTOVvXo0OZ0Kvlq1h/ZeiWw+Oh/xaRhNPboF+Tilyde\r\n"
    "PuN+McxJAT7TIW9x9+Q162XuG+ykuoxcef9NSUPBlIggMpAE1hJc6qIgQ0Ixkfh5\r\n"
    "ACny6boXOJ7GgYBhVvR1MDayvEkKuZP6/83CGkmrvE2Y3uFodKMMyWjv/TkQeNqV\r\n"
    "b4D7+E3KAjRXcRMFkDHwyzwJnHIDGhXqSnaJ5UiTyc44bjR40xQ0ml6zGYXcu9/G\r\n"
    "5F4RJDmShrhlfG+PsaqLzr7a9aM4CvpNwXX+vwIDAQABAoIBAQCYm/P/jjIAe1uz\r\n"
    "NbT24qVhPU20waZvf9BGuWFzbYrkZ3nwWm/ov2hAmZz18IDTlNIT/eyjmJmUUyyN\r\n"
    "ciKTvdoG2JAuRMKlao6balduTEuLlBiY09FN6K1Hsv1pLpYsqBZhU/2eYQk1FoOL\r\n"
    "RB1eK/Pv4Y2NEvL00FZK7eQvTWRjP2ZNaWV+w4hbbuSuQ8yuMF4Qje4uMmBm3bh6\r\n"
    "mMzO+uwb0zn85u2U/ueVmaO5EEioR6Paq9QKicgt5+RSNkA9RsoYT7GsmHyBl0wV\r\n"
    "9dh6Kn01XpgRy13NXpA8LFdYnoJO4cf70KvbSLnD2KJWcYQqj2/ebhPM52UDodFW\r\n"
    "6Yp2XjyxAoGBAOGqtUkOT4/X03ucJAGuzsfaGumucGF+lST/ZlnAVuAbImbkmBdO\r\n"
    "LXZel9ZewyL4QJEmSX45SfmJEiMXu0d7kq56EdDlxFIU2qb9ceEMBBBSINs+pdpO\r\n"
    "hDJ5bN3OfXJ6owBBNH3MEbHZe1jY/HT3m0KlHE5dGyZhNO0mJgREJTqFAoGBAOBg\r\n"
    "2XvdMS0Tld4UGS+OAgtfkTScOr7+bbi/q3sypaLkO75OV+zF7filEZhQugXMuQKy\r\n"
    "oLsUPsB1h9gntVOJxa6VmuewW/UplpTwdDYzWEihI6nW7cOWJL/CiiE32Pms2T90\r\n"
    "8ebO3boVVvxqJeDYKcb6w/6XOAW6wuUzcshmyHFzAoGAV3pyTgCjLPKQQ6GSf6iA\r\n"
    "9g4BUsbRP6nvLOlohrA9vSAnpNVGc/pVO0aN+4a+hEbR2LKL2Mdier387uebLKml\r\n"
    "gcdGMsFu6ha1b/hddczPongDzpmpd0fqjRpu7kjGbmNF3qpoK7+4uEXDP/zVWI5H\r\n"
    "fH0+zM3g4W7bMncQU6UK/XUCgYA0hrejBX7znHgjCvVyan4UB4VImaIvAATTkRsl\r\n"
    "tg+MeH176X8v0I4K/SmHTK6fmPNerE5wPScLivgIJBOQwNnkKuWeg2yjkd7McxXh\r\n"
    "cleieQaOReBXPxjPQ01uxVIn8MzSzB+s9pR1cXVxla/UWQY+rImhWeklfjkNyuN+\r\n"
    "AoG9/QKBgQCbv1V7RvMfMfxf7gmEPY7iV3R7wAOMELpA8HwKsFUQWYnObvIi0By7\r\n"
    "RIaeVRwrudFO3oDh//5+W4EHTs0v3v0YEHIXlgasK0rhu2ijLoE7jFmjKroZsOLk\r\n"
    "QBh7MDZRnGsQjKD6A0T3+aHTLTGwIDFqzRtohsYyun8x0gjg+TUkqA==\r\n"
    "-----END RSA PRIVATE KEY-----\r\n"
};
