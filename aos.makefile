...
%.o:
    ...
    $(CROSS_PREFIX)gcc -c \
        -o $@ \
        -DOTA_WITH_LINKKIT -DFORCE_SSL_VERIFY -DCOAP_OBSERVE_SERVER_SUPPORTED -DCOAP_OBSERVE_CLIENT_SUPPORTED -DCOAP_SERV_MULTITHREAD -DCOAP_USE_PLATFORM_MEMORY -DCOAP_USE_PLATFORM_LOG -DALCS_ENABLED -DHTTP_COMM_ENABLED -DMQTT_COMM_ENABLED -DMQTT_DIRECT -DSDK_ENHANCE -DSUPPORT_TLS -DCM_ENABLED -DDM_ENABLED -DCONFIG_DM_DEVTYPE_SINGLE -DCMP_VIA_MQTT_DIRECT $(CONFIG_ENV_CFLAGS) -g3 -DBUILD_AOS -DIOTX_NET_INIT_WITH_PK_EXT -DCONFIG_CM_VIA_CLOUD_CONN -DCM_VIA_CLOUD_CONN_MQTT -DCM_SUPPORT_MULTI_THREAD_VIA_HAL -I../../../../../include -I../../../../activation -DCONFIG_CM_SUPPORT_LOCAL_CONN -DCONFIG_DM_SUPPORT_LOCAL_CONN -DCONFIG_HTTP_AUTH_TIMEOUT=500 -DCONFIG_MID_HTTP_TIMEOUT=500 -DCONFIG_GUIDER_AUTH_TIMEOUT=500 -DCONFIG_MQTT_TX_MAXLEN=640 -DCONFIG_MQTT_RX_MAXLEN=1200 \
            -Isrc/infra/utils \
