...
INPUT_FLAGS := -DOTA_WITH_LINKKIT -DFORCE_SSL_VERIFY -DCOAP_OBSERVE_SERVER_SUPPORTED -DCOAP_OBSERVE_CLIENT_SUPPORTED -DCOAP_SERV_MULTITHREAD -DCOAP_USE_PLATFORM_MEMORY -DCOAP_USE_PLATFORM_LOG -DALCS_ENABLED -DCMP_VIA_MQTT_DIRECT -DDEPRECATED_LINKKIT -DENHANCED_GATEWAY -DHTTP_COMM_ENABLED -DMQTT_COMM_ENABLED -DMQTT_DIRECT -DSDK_ENHANCE -DSUBDEVICE_ENABLED -DSUPPORT_TLS -DCONFIG_CM_VIA_CLOUD_CONN -DCONFIG_CM_SUPPORT_LOCAL_CONN -DCONFIG_DM_SUPPORT_LOCAL_CONN -DCONFIG_DM_DEVTYPE_GATEWAY -DCONFIG_SDK_THREAD_COST=1 $(CONFIG_ENV_CFLAGS) -Os -DBUILD_AOS -I../../../../../include -I../../../../activation -DCONFIG_HTTP_AUTH_TIMEOUT=500 -DCONFIG_MID_HTTP_TIMEOUT=500 -DCONFIG_MQTT_TX_MAXLEN=640 -DCONFIG_MQTT_RX_MAXLEN=1200 -Werror 
GATEEAY_OBJS := .O/src/services/subdev/iotx_subdev_api.o \
    .O/src/services/subdev/iotx_subdev_common.o
else
INPUT_FLAGS := -DOTA_WITH_LINKKIT -DFORCE_SSL_VERIFY -DCOAP_OBSERVE_SERVER_SUPPORTED -DCOAP_OBSERVE_CLIENT_SUPPORTED -DCOAP_SERV_MULTITHREAD -DCOAP_USE_PLATFORM_MEMORY -DCOAP_USE_PLATFORM_LOG -DALCS_ENABLED -DCMP_VIA_MQTT_DIRECT -DDEPRECATED_LINKKIT -DHTTP_COMM_ENABLED -DMQTT_COMM_ENABLED -DMQTT_DIRECT -DSDK_ENHANCE -DSUPPORT_TLS -DCONFIG_CM_VIA_CLOUD_CONN -DCONFIG_CM_SUPPORT_LOCAL_CONN -DCONFIG_DM_SUPPORT_LOCAL_CONN -DCONFIG_DM_DEVTYPE_SINGLE $(CONFIG_ENV_CFLAGS) -Os -DBUILD_AOS -I../../../../../include -I../../../../activation -DCONFIG_HTTP_AUTH_TIMEOUT=500 -DCONFIG_MID_HTTP_TIMEOUT=500 -DCONFIG_MQTT_TX_MAXLEN=640 -DCONFIG_MQTT_RX_MAXLEN=1200 -Werror       
endif
