...
typedef enum IOTX_CLOUD_CONNECTION_PROTOCOL_TYPES {
    /* MQTT */
    IOTX_CLOUD_CONNECTION_PROTOCOL_TYPE_MQTT,
    
    /* CoAP */
    IOTX_CLOUD_CONNECTION_PROTOCOL_TYPE_COAP,
    
    /* HTTP */
    IOTX_CLOUD_CONNECTION_PROTOCOL_TYPE_HTTP,
...
typedef enum IOTX_CLOUD_CONNECTION_RESPONSE_TYPES {
    /* subcribe success */
    IOTX_CLOUD_CONNECTION_RESPONSE_SUBSCRIBE_SUCCESS,    
    
    /* subcribe fail */
    IOTX_CLOUD_CONNECTION_RESPONSE_SUBSCRIBE_FAIL,  
    
    /* subcribe success */
    IOTX_CLOUD_CONNECTION_RESPONSE_UNSUBSCRIBE_SUCCESS,    
    
    /* subcribe fail */
    IOTX_CLOUD_CONNECTION_RESPONSE_UNSUBSCRIBE_FAIL,   
    
    /* send success */
    IOTX_CLOUD_CONNECTION_RESPONSE_SEND_SUCCESS,    
    
    /* send fail */
    IOTX_CLOUD_CONNECTION_RESPONSE_SEND_FAIL,      
    
    /* receive new data */
    IOTX_CLOUD_CONNECTION_RESPONSE_NEW_DATA,       
...
typedef enum IOTX_CLOUD_CONNECTION_MESSAGE_TYPES {
    /* MQTT: subcribe */
    IOTX_CLOUD_CONNECTION_MESSAGE_TYPE_SUBSCRIBE,    
    
    /* MQTT: unsubcribe */
    IOTX_CLOUD_CONNECTION_MESSAGE_TYPE_UNSUBSCRIBE,    
    
    /* MQTT: publish; CoAP & HTTP: send message */
    IOTX_CLOUD_CONNECTION_MESSAGE_TYPE_PUBLISH,
