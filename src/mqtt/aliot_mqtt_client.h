 ...
 * @return NULL, construct fialed; NOT NULL, the handle of MQTT client.
 */
void *aliot_mqtt_construct(aliot_mqtt_param_t *pInitParams);


/**
 * @brief Deonstruct the MQTT client
 ...
 *        which include the MQTT subscribe, unsubsribe, publish(QOS >= 1), reconnect, etc..
 *
 * @param handle, specify the MQTT client.
 ...
 *
 * @return the unique ID of this request. It will pass back when calling @aliot_mqtt_param_t:handle_event.
 */
