...
#define STATE_MQTT_WAIT_RECONN_TIMER                     (STATE_BASE - 0x0001)
...
#define STATE_USER_INPUT_HTTP_RECV_MOREDATA         (STATE_USER_INPUT_BASE - 0x000E)
...
#define STATE_MQTT_SIGN_HOSTNAME_BUF_SHORT          (STATE_MQTT_BASE - 0x0006)
#define STATE_MQTT_SIGN_USERNAME_BUF_SHORT          (STATE_MQTT_BASE - 0x0007)
#define STATE_MQTT_SIGN_CLIENTID_BUF_SHORT          (STATE_MQTT_BASE - 0x0008)
#define STATE_MQTT_SIGN_SOURCE_BUF_SHORT            (STATE_MQTT_BASE - 0x0009)
#define STATE_MQTT_WRAPPER_INIT_FAIL                (STATE_MQTT_BASE - 0x000A)
#define STATE_MQTT_SERIALIZE_CONN_ERROR             (STATE_MQTT_BASE - 0x000B)
#define STATE_MQTT_SERIALIZE_CONNACK_ERROR          (STATE_MQTT_BASE - 0x000C)
...
#define STATE_MQTT_SERIALIZE_PUBLISH_ERROR          (STATE_MQTT_BASE - 0x0011)
#define STATE_MQTT_DESERIALIZE_SUBACK_ERROR         (STATE_MQTT_BASE - 0x0012)
#define STATE_MQTT_DESERIALIZE_PUBLISH_ERROR        (STATE_MQTT_BASE - 0x0013)
#define STATE_MQTT_DESERIALIZE_UBSUBACK_ERROR       (STATE_MQTT_BASE - 0x0014)
#define STATE_MQTT_PACKET_READ_ERROR                (STATE_MQTT_BASE - 0x0015)
#define STATE_MQTT_CONNACK_UNKNOWN_ERROR            (STATE_MQTT_BASE - 0x0016)
#define STATE_MQTT_RX_BUFFER_TOO_SHORT              (STATE_MQTT_BASE - 0x0017)
#define STATE_MQTT_TX_BUFFER_TOO_SHORT              (STATE_MQTT_BASE - 0x0018)
#define STATE_MQTT_TOPIC_BUF_TOO_SHORT              (STATE_MQTT_BASE - 0x0019)
#define STATE_MQTT_CONN_RETRY_EXCEED_MAX            (STATE_MQTT_BASE - 0x001A)
#define STATE_MQTT_QOS1_REPUB_EXCEED_MAX            (STATE_MQTT_BASE - 0x001B)
#define STATE_MQTT_PUB_QOS_INVALID                  (STATE_MQTT_BASE - 0x001C)
#define STATE_MQTT_IN_OFFLINE_STATUS                (STATE_MQTT_BASE - 0x001D)
#define STATE_MQTT_RECV_UNKNOWN_PACKET              (STATE_MQTT_BASE - 0x001E)
#define STATE_MQTT_CLI_EXCEED_MAX                   (STATE_MQTT_BASE - 0x001F)
#define STATE_MQTT_SUB_EXCEED_MAX                   (STATE_MQTT_BASE - 0x0020)
#define STATE_MQTT_UNEXP_TOPIC_FORMAT               (STATE_MQTT_BASE - 0x0021)
#define STATE_MQTT_SYNC_SUB_TIMEOUT                 (STATE_MQTT_BASE - 0x0022)
#define STATE_MQTT_ASYNC_STACK_CONN_IN_PROG         (STATE_MQTT_BASE - 0x0023)
#define STATE_MQTT_ASYNC_STACK_NOT_SUPPORT          (STATE_MQTT_BASE - 0x0024)
#define STATE_MQTT_ASYNC_STACK_UNKNOWN_EVENT        (STATE_MQTT_BASE - 0x0025)
