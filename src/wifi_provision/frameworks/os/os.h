 ...
 * @see None.
 * @note None.
 static  int os_is_big_endian(void)
 */
...
#if 0
#define os_mutex_init platform_mutex_init
#endif
 ...
 */
#define os_malloc  platform_malloc 
 ...
 * @note None.
 */
#define os_sys_net_is_ready platform_sys_net_is_ready 
 ...
 */
#define os_awss_get_channelscan_interval_ms platform_awss_get_channelscan_interval_ms 
