...
typedef enum IOTX_CONNECTION_EVENT_TYPES {
    ...
    IOTX_CONNECTION_EVENT_ADD_DEVICE,
...
typedef struct iotx_connection_st {
    ...
    iotx_cm_connection_remove_service_fp_t      remove_service_func;
    iotx_cm_connection_send_fp_t                send_func;
    iotx_cm_connection_add_subdevice_fp_t       add_subdevice_func;
    iotx_cm_connection_remove_subdevice_fp_t    remove_subdevice_func;
