...
int __attribute__((weak)) awss_report_token_reply(char *topic, int topic_len, void *payload, int payload_len, void *ctx)
{
    return 0;
}
int __attribute__((weak)) awss_report_reset_reply(char *topic, int topic_len, void *payload, int payload_len, void *ctx)
{
    return 0;
}
int __attribute__((weak)) awss_enrollee_checkin(char *topic, int topic_len, void *payload, int payload_len, void *ctx)
{
    return 0;
}
int __attribute__((weak)) awss_report_enrollee_reply(char *topic, int topic_len, void *payload, int payload_len, void *ctx)
{
    return 0;
}
int __attribute__((weak)) awss_get_cipher_reply(char *topic, int topic_len, void *payload, int payload_len, void *ctx)
{
    return 0;
}
int __attribute__((weak)) awss_online_switchap(char *topic, int topic_len, void *payload, int payload_len, void *ctx)
{
    return 0;
}
